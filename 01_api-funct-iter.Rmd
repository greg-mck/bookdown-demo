...
raw_data <- httr:: GET( url = "https://irmaservices.nps.gov/v3/rest/stats/visitation?unitCodes=ROMO&startMonth=01&startYear=2010&endMonth=01&endYear=2021" )
unpacked_data <- httr::content(raw_data, as = "text", encoding = "UTF-8") 
final_data <- jsonlite::fromJSON(unpacked_data)
final_data
...
parkwide_visitation <- function(year = 2022){

  raw_data <- GET(url = paste0("https://irmaservices.nps.gov/v3/rest/stats/total/",year))
  unpacked_data <- httr::content(raw_data, as = "text", encoding = "UTF-8")
  final_data <- jsonlite::fromJSON(unpacked_data)
  return(final_data)
...
test <- parkwide_visitation( year = 1994)
```
...
unit_visitation <- function(UNITCODE = "ROMO", STARTMONTH = 01, STARTYEAR = 2010, ENDMONTH = 12, ENDYEAR = 2022){
...
test <- unit_visitation(UNITCODE = "ACAD", STARTMONTH = 04, STARTYEAR = 2020, ENDMONTH = 04, ENDYEAR = 2021)
...
pullROMO <- unit_visitation(UNITCODE = "ROMO", STARTMONTH = 01, STARTYEAR = 1990, ENDMONTH = 12, ENDYEAR = 2021)

pullEVER <- unit_visitation(UNITCODE = "EVER", STARTMONTH = 01, STARTYEAR = 1990, ENDMONTH = 12, ENDYEAR = 2021)

pullTHRO <- unit_visitation(UNITCODE = "THRO", STARTMONTH = 01, STARTYEAR = 1990, ENDMONTH = 12, ENDYEAR = 2021)
```
...
test <- unit_visitation(UNITCODE = "ACAD")
tail(test)
```
...
for(i in 1:length(parks)){
  ...
  output_floop[[i]] <-
    unit_visitation(UNITCODE = parks[i])
  
}
#summary(output_floop)
multi_parks <- dplyr::bind_rows(output_floop)
```
...
#identical(output_floop, output_map)
multi_parks <- bind_rows(output_map)
#head(multi_parks)
#tail(multi_parks)
```
